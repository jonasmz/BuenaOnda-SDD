...
- [X] T050 [P] [US4] Agregar en `FE/pages/categories/` y `FE/pages/products/` las acciones de dar de baja y reactivar, con estado visible (depende de T021, T032)
- [X] T051 [US4] Crear el formulario de edición de opción en `FE/components/option-form/` con precio, descripción, imagen, conmutador de disponibilidad manual y acciones de dar de baja, reactivar y eliminar la opción (mostrando el conflicto 409 con la opción de baja), con su prueba en `FE/components/option-form/option-form.spec.ts` (depende de T043, T049)
